"""Cross-check the token set against the scraped SlowMist Hacked database.
...
res = json.load(open(f"{DATA}/abi_analysis.json"))
...
json.dump({"matched": out}, open(f"{DATA}/hack_matches.json", "w"), indent=1)
