"""Cross-check the Base token set against the scraped SlowMist Hacked database.
...
res = json.load(open(f"{DATA}/base_abi_analysis.json"))
...
json.dump({"matched": out}, open(f"{DATA}/base_hack_matches.json", "w"), indent=1)
